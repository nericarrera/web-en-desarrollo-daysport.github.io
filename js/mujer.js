...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const productos = [
        { id: 1, nombre: "Calza Deportiva", categoria: "calzas", imagen: "calza1.jpg" },
        { id: 2, nombre: "Campera de Invierno", categoria: "camperas", imagen: "campera1.jpg" },
        { id: 3, nombre: "Conjunto Deportivo", categoria: "conjuntos", imagen: "conjunto1.jpg" },
        { id: 4, nombre: "Jean Clásico", categoria: "jeans", imagen: "jean1.jpg" },
        { id: 5, nombre: "Pantalón Chino", categoria: "pantalones", imagen: "pantalon1.jpg" },
        { id: 6, nombre: "Remera Casual", categoria: "remeras", imagen: "remera1.jpg" },
        { id: 7, nombre: "Short Deportivo", categoria: "deportivo", imagen: "short1.jpg" },
        { id: 8, nombre: "Campera Casual", categoria: "camperas", imagen: "campera2.jpg" },
        { id: 9, nombre: "Remera Deportiva", categoria: "remeras", imagen: "remera2.jpg" },
    ];
    ...
    // Agregar productos iniciales (mostrar todo)
    mostrarProductos("all");

    // Agregar productos grid al DOM después del filtro
    document.querySelector('.horizontal-filter').insertAdjacentElement('afterend', productsGrid);

    // Configurar eventos de los botones del filtro
